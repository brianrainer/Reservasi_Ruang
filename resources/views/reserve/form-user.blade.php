...
<div class="row">
  <div class="input-field col s12 m6">
    ...
    <input type="text" value="{{ old('phone_number') }}" id="phone_number" name="phone_number" class="validate" pattern="[0-9]{8,12}" required>
  ...
  <div class="input-field col s12 m6">
    ...
    <input type="email" value="{{ old('email') }}" name="email" id="email" class="validate" required>
...
<div class="row">
  <div class="input-field col s12 m6">
    ...
    <input type="text" id="pic_title_1" name="pic_title_1" value="{{old('pic_title_1')}}" class="validate" required>
  ...
  <div class="input-field col s12 m6">
    <i class="material-icons prefix"></i>
    <input type="text" id="pic_name_1" name="pic_name_1" value="{{old('pic_name_1')}}" class="validate" required>
  ...
  <div class="input-field col s12 m6">
    <i class="material-icons prefix"></i>
    <input type="text" id="pic_title_2" name="pic_title_2" value="{{old('pic_title_2')}}" class="validate">
  ...
  <div class="input-field col s12 m6">
    <i class="material-icons prefix"></i>
    <input type="text" id="pic_name_2" name="pic_name_2" value="{{old('pic_name_2')}}" class="validate">
