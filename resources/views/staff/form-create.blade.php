    ...
    <form class="col s12" method="POST" action="{{url('/staff/create')}}">
      ...
      <div class="row">
        <div class="input-field col s12">
          ...
          <label for="user__name">Nama Lengkap</label>
        </div>
      </div>
      <div class="row">
        <div class="input-field col s12">
      ...
      <div class="row">
        <div class="input-field col s12">
          <input type="text" value="{{ old('user_phone_number') }}" id="user_phone_number" name="user_phone_number" class="validate" required>
